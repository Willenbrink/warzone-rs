 ...
 */
    ...
    #[no_mangle]
    static mut psCurrRes: *mut STR_RES;
    /* Give access to the line number and current text for error messages */
    #[no_mangle]
    fn strresGetErrorData(pLine: *mut libc::c_int,
                          ppText: *mut *mut libc::c_char);
    /* Store a string */
    #[no_mangle]
    fn strresStoreString(psRes: *mut STR_RES, pID: *mut STRING,
                         pString: *mut STRING) -> BOOL;
...
#[no_mangle]
pub unsafe extern "C" fn strres_error(mut pMessage: *const libc::c_char,
                                      mut args: ...) {
    let mut line: libc::c_int = 0;
    let mut pText: *mut libc::c_char = 0 as *mut libc::c_char;
    strresGetErrorData(&mut line, &mut pText);
    debug(LOG_ERROR,
          b"STRRES file parse error:\n%s at line %d\nText: \'%s\'\n\x00" as
              *const u8 as *const libc::c_char, pMessage, line, pText);
    abort();
}
/* YYTRANSLATE[TOKEN-NUM] -- Symbol number corresponding to TOKEN-NUM
   as returned by yylex.  */
static mut yytranslate: [yytype_int8; 260] =
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
     STATE-NUM.  */
static mut yypact: [yytype_int8; 7] =
    [-(2 as libc::c_int) as yytype_int8, 1 as libc::c_int as yytype_int8,
     0 as libc::c_int as yytype_int8, -(3 as libc::c_int) as yytype_int8,
...
static mut yydefact: [yytype_int8; 7] =
    [0 as libc::c_int as yytype_int8, 0 as libc::c_int as yytype_int8,
     ...
     3 as libc::c_int as yytype_int8];
/* YYPGOTO[NTERM-NUM].  */
static mut yypgoto: [yytype_int8; 3] =
    [-(3 as libc::c_int) as yytype_int8, -(3 as libc::c_int) as yytype_int8,
     2 as libc::c_int as yytype_int8];
/* YYDEFGOTO[NTERM-NUM].  */
static mut yydefgoto: [yytype_int8; 3] =
    [-(1 as libc::c_int) as yytype_int8, 2 as libc::c_int as yytype_int8,
     3 as libc::c_int as yytype_int8];
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
     positive, shift that token.  If negative, reduce the rule whose
     number is the opposite.  If YYTABLE_NINF, syntax error.  */
static mut yytable: [yytype_int8; 6] =
...
static mut yycheck: [yytype_int8; 6] =
    [0 as libc::c_int as yytype_int8, 3 as libc::c_int as yytype_int8,
...
static mut yystos: [yytype_int8; 7] =
    [0 as libc::c_int as yytype_int8, 3 as libc::c_int as yytype_int8,
...
static mut yyr1: [yytype_int8; 5] =
    [0 as libc::c_int as yytype_int8, 5 as libc::c_int as yytype_int8,
     6 as libc::c_int as yytype_int8, 6 as libc::c_int as yytype_int8,
     7 as libc::c_int as yytype_int8];
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static mut yyr2: [yytype_int8; 5] =
    [0 as libc::c_int as yytype_int8, 2 as libc::c_int as yytype_int8,
     1 as libc::c_int as yytype_int8, 2 as libc::c_int as yytype_int8,
     2 as libc::c_int as yytype_int8];
/* YYERROR_VERBOSE */
...
#[no_mangle]
pub static mut strres_char: libc::c_int = 0;
/* The semantic value of the lookahead symbol.  */
#[no_mangle]
pub static mut strres_lval: YYSTYPE =
    YYSTYPE{sval: 0 as *const STRING as *mut STRING,};
/* Number of syntax errors so far.  */
#[no_mangle]
pub static mut strres_nerrs: libc::c_int = 0;
/* Call the yacc parser */
/*----------.
| yyparse.  |
`----------*/
#[no_mangle]
pub unsafe extern "C" fn strres_parse() -> libc::c_int {
    ...
    strres_nerrs = 0 as libc::c_int;
    strres_char = -(2 as libc::c_int);
    's_88:
        loop 
             /*--------------------------------------------------------------------.
...
`--------------------------------------------------------------------*/
             {
            (0 as libc::c_int != 0 &&
                 (0 as libc::c_int <= yystate && yystate < 7 as libc::c_int))
                as libc::c_int;
            *yyssp = yystate as yy_state_t;
            if yyss.offset(yystacksize as
                ...
                if 10000 as libc::c_int <= yystacksize {
                    current_block = 10377827742289678798;
                    break ;
                }
                ...
                if yyss.offset(yystacksize as
                                   isize).offset(-(1 as libc::c_int as isize))
                       <= yyssp {
                    current_block = 781587046472357689;
                    break ;
                }
            }
            /* !defined yyoverflow && !defined YYSTACK_RELOCATE */
            if yystate == 5 as libc::c_int {
                /*-------------------------------------.
| yyacceptlab -- YYACCEPT comes here.  |
`-------------------------------------*/
                yyresult = 0 as libc::c_int;
                current_block = 4949394507576269911;
                break ;
            } else {
                /*-----------.
| yybackup.  |
`-----------*/
     ...
     lookahead token if we need one and don't already have one.  */
                ...
                if yyn == -(3 as libc::c_int) {
                    current_block = 3889539373966549683;
                } else {
                    /* Not known => get a lookahead token if don't already have one.  */
                    /* YYCHAR is either YYEMPTY or YYEOF or a valid lookahead symbol.  */
                    if strres_char == -(2 as libc::c_int) {
                        strres_char = strres_lex()
                    }
                    if strres_char <= 0 as libc::c_int {
                        yytoken = 0 as libc::c_int;
                        strres_char = yytoken
                    } else {
                        yytoken =
                            if 0 as libc::c_int <= strres_char &&
                                   strres_char <= 259 as libc::c_int {
                                yytranslate[strres_char as usize] as
                                    libc::c_int
     ...
     detect an error, take that action.  */
                    yyn += yytoken;
                    if yyn < 0 as libc::c_int || (5 as libc::c_int) < yyn ||
     ...
     status.  */
                            ...
                            *yyvsp = strres_lval;
                            ...
                            strres_char = -(2 as libc::c_int);
                            current_block = 16838473045109834629;
                        }
                    }
                }
                match current_block {
...
`--------------------------------------*/
     ...
     user semantic actions for why this is necessary.  */
                            yytoken =
                                if strres_char == -(2 as libc::c_int) {
                                    -(2 as libc::c_int)
                                } else if 0 as libc::c_int <= strres_char &&
                                              strres_char <=
                                                  259 as libc::c_int {
                                    yytranslate[strres_char as usize] as
                                        libc::c_int
                            ...
                            if yyerrstatus == 0 {
                                strres_nerrs += 1;
                                strres_error(b"syntax error\x00" as *const u8
...
`-------------------------------------------------------------*/
                            ...
                            *yyvsp = strres_lval;
                            ...
                            yystate = yyn;
                            current_block = 16838473045109834629;
                        } else { current_block = 15750721572495859450; }
                    }
                    _ => { }
                }
                match current_block {
...
`-----------------------------*/
     ...
     GCC warning that YYVAL may be used uninitialized.  */
                        ...
                        match yyn {
                            4 => {
                                if strresStoreString(psCurrRes,
                                                     (*yyvsp.offset(-(1 as
                                                                          libc::c_int)
                                                                        as
                                                                        isize)).sval,
...
`------------------------------------------------------------*/
    ...
    match current_block {
        10377827742289678798 =>
        /*-------------------------------------------------.
| yyexhaustedlab -- memory exhaustion comes here.  |
`-------------------------------------------------*/
        {
            strres_error(b"memory exhausted\x00" as *const u8 as
                             *const libc::c_char);
...
`-----------------------------------------------------*/
    if strres_char != -(2 as libc::c_int) {
        ...
        yytoken =
            if 0 as libc::c_int <= strres_char &&
                   strres_char <= 259 as libc::c_int {
                yytranslate[strres_char as usize] as libc::c_int
            } else { 2 as libc::c_int };
        yydestruct(b"Cleanup: discarding lookahead\x00" as *const u8 as
                       *const libc::c_char, yytoken, &mut strres_lval);
    }
