...
union YYSTYPE
{
#line 42 "resource_parser.y"

	STRING  *sval;

#line 184 "resource_parser.c"
...
static const char *const yytname[] =
{
  ...
  "FILETOKEN", "$accept", "res_file", "res_line", "dir_line", "file_line", YY_NULLPTR
};
#endif
...
#line 64 "resource_parser.y"
												...
												(yyvsp[0].sval)[0] == '\\')
											{
												...
												strcpy(aCurrResDir, (yyvsp[0].sval));
											}
											else
											{
...
#line 1375 "resource_parser.c"
    break;

  case 7:
#line 94 "resource_parser.y"
                                                                                {
											/* load a data file */
											DBP1(("file: %s %s\n", (yyvsp[-1].sval), (yyvsp[0].sval)));
											if (!resLoadFile((yyvsp[-1].sval), (yyvsp[0].sval)))
											{
												YYABORT;
											}
										}
#line 1388 "resource_parser.c"
    break;


#line 1392 "resource_parser.c"
